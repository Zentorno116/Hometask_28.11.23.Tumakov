...
class Program
{
    static void Main()
    {
        Console.WriteLine("Упражнение 9.1 Тумаков. Банк с конструктором.");
        ...
        Console.ReadKey();
        Console.Clear();
        Console.WriteLine("Упражнение 9.2 Тумаков. Банк с BankTransaction. ");
        account = new BankAccount(10112023m, AccountType.Savings);
